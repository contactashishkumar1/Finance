...
,
        ...
        { name: "Saudi Arabia to Philippines Money Transfer Guide", url: "/money-transfer/country-guides/saudi-arabia-to-philippines/", icon: "🌍", keys: "saudi arabia to philippines money transfer guide money transfer country guides saudi arabia to philippines index html" },
        { name: "US to Nigeria Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/us-to-nigeria/", icon: "🌍", keys: "us to nigeria money transfer guide arthcalculator money transfer country guides us to nigeria index html" },
        { name: "Australia to India Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/australia-to-india/", icon: "🌍", keys: "australia to india money transfer guide arthcalculator money transfer country guides australia to india index html" },
        { name: "New Zealand to Pacific Islands Money Transfer Guide", url: "/money-transfer/country-guides/new-zealand-to-pacific/", icon: "🌍", keys: "new zealand to pacific islands money transfer guide money transfer country guides new zealand to pacific index html" },
        { name: "UAE to Pakistan Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/uae-to-pakistan/", icon: "🌍", keys: "uae to pakistan money transfer guide arthcalculator money transfer country guides uae to pakistan index html" },
        { name: "Canada to India Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/canada-to-india/", icon: "🌍", keys: "canada to india money transfer guide arthcalculator money transfer country guides canada to india index html" },
        { name: "Saudi Arabia to India Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/saudi-arabia-to-india/", icon: "🌍", keys: "saudi arabia to india money transfer guide arthcalculator money transfer country guides saudi arabia to india index html" },
        { name: "UK to Philippines Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/uk-to-philippines/", icon: "🌍", keys: "uk to philippines money transfer guide arthcalculator money transfer country guides uk to philippines index html" },
        { name: "UK to Pakistan Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/uk-to-pakistan/", icon: "🌍", keys: "uk to pakistan money transfer guide arthcalculator money transfer country guides uk to pakistan index html" },
        { name: "Australia to Nepal Money Transfer Guide | ArthCalculator", url: "/money-transfer/country-guides/australia-to-nepal/", icon: "🌍", keys: "australia to nepal money transfer guide arthcalculator money transfer country guides australia to nepal index html" }
    ];
